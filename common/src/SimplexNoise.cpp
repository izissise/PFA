...
float octave_noise_2d(float octaves, float persistence, float scale,
		      float x, float y)
{
  float total = 0;
...
float octave_noise_3d(float octaves, float persistence, float scale,
...
float octave_noise_4d(float octaves, float persistence, float scale,
...
float scaled_octave_noise_3d(float octaves, float persistence,
			     float scale, float loBound, float hiBound,
			     float x, float y, float z)
{
...
float scaled_octave_noise_4d(float octaves, float persistence,
			     float scale, float loBound, float hiBound,
			     float x, float y, float z, float w)
{
...
float scaled_raw_noise_4d(float loBound, float hiBound,
			  float x, float y, float z, float w)
{
...
float raw_noise_4d(float x, float y, float z, float w) {
...
float dot3(const int* g, float x, float y, float z)
{
  return g[0] * x + g[1] * y + g[2] * z;
}

float dot4(const int* g, float x, float y, float z, float w)
{
