...
inline void Player::set_has_life() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Player::clear_has_life() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline ::google::protobuf::int32 Player::life() const {
  // @@protoc_insertion_point(field_get:Player.life)
  return life_;
}
inline void Player::set_life(::google::protobuf::int32 value) {
  set_has_life();
  life_ = value;
  // @@protoc_insertion_point(field_set:Player.life)
}
